...
import { FaBath, FaBed, FaCar, FaSort, FaSortDown, FaSortUp } from "react-icons/fa";
import { Badge, ButtonGroup, Card, Col, Container, ListGroup, Row, Stack, Table } from "react-bootstrap";
import { renderMapboxMap } from "../../../Components/Maps/getCordinates";
      ...
      <Container className="p-5">
        <Stack direction="horizontal" gap={3} className="pb-3">
          ...
          <div className="ms-auto">
            <Link className="btn btn-primary" to="/ListingPage">Back</Link>
          </div>
        </Stack>
        <Row>
          <Col lg={8}>
                ...
                <Table striped bordered hover responsive>
                  ...
                  <tbody>
                    {sortedListings.map((listing, index) => (
                      <tr key={index}>
                        <td><Link to={`/ListingDetail/${listing._id}`}>{listing.type}</Link></td>
