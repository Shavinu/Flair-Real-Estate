...
import { Badge, ButtonGroup, Card, Col, Container, ListGroup, Row, Stack } from "react-bootstrap";
...
import CardCarousel from "../../Listing/Components/ImageCarousel";
      ...
      <Container className="p-5">
        <Stack direction="horizontal" gap={3} className="pb-3">
          ...
          <div className="ms-auto">
            <Link className="btn btn-primary" to={`/ProjectDetail/${listing.project}`}>Back</Link>
          </div>
        </Stack>
        <Row>
          <Col lg={8}>
